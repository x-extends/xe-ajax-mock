...
var x=u("DELETE");var t=u("PATCH");var e="1.4.4";function q(D){return B(C,D)}q({setup:m,install:l,JSONP:k,Mock:g,GET:y,POST:d,PUT:h,DELETE:x,PATCH:t,version:e});C.mixin=q;return C}));