...
``` shell
<script src="https://cdn.jsdelivr.net/npm/xe-ajax-mock@1.4.9/dist/xe-ajax-mock.js"></script>
```
#### unpkg 获取最新版本, [点击浏览](https://unpkg.com/xe-ajax-mock@1.4.9/)已发布的所有 npm 包的源代码
``` shell
<script src="https://unpkg.com/xe-ajax-mock@1.4.9/dist/xe-ajax-mock.js"></script>
```
...
RequireJS + VXEAjax + Mock 项目例子3 请参考 [vue-mock3](https://github.com/xuliangzhan/xe-ajax-mock/tree/master/examples/vue-mock3) 示例
