...
}}function u(D){return function(G,E,F){return C(G,D,E,F)}}function k(F,D,E){return C(F,"GET",D,B({jsonp:"callback"},E))}var g=C;var y=u("GET");var d=u("POST");var h=u("PUT");var x=u("DELETE");var t=u("PATCH");var e="1.4.7";function q(D){return B(C,D)}q({setup:m,install:l,JSONP:k,Mock:g,GET:y,POST:d,PUT:h,DELETE:x,PATCH:t,version:e});C.mixin=q;return C}));